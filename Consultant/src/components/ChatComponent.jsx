...
const styles = {
    ...
    myMessage: {
      background: '#2E7D32', // Deeper green for the sender
      color: 'white',
      padding: '10px',
      borderRadius: '10px',
      maxWidth: '70%',
    ...
    theirMessage: {
      background: '#C8E6C9', // Lighter green for the receiver
      padding: '10px',
      borderRadius: '10px',
      maxWidth: '70%',
    },
    ...
    messageTime: {
      fontSize: '12px',
      marginTop: '8px',
      color: '#4C8C4A', // Complementary green color for the time
      textAlign: 'right',
    },
    messageForm: {
      display: 'flex',
      padding: '20px',
      borderTop: '1px solid #388E3C', // Border to match the green theme
    },
    messageInput: {
      flexGrow: 1,
      marginRight: '10px',
    ...
    sendMessageButton: {
      background: '#43A047', // Vibrant green for the button
      color: 'white',
      border: 'none',
      borderRadius: '20px',
      padding: '10px 20px',
